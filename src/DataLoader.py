...
class DataLoader:
    ...
    def __init__(self, filePath, batchSize, imgSize, maxTextLen):
        ...
        with open(filePath + 'labels-vn.json', encoding="utf8") as json_data:
            label_file = json.load(json_data)
        ...
        self.charList = list(open(FilePaths.fnCharList, encoding="utf8").read())
    ...
    def getNext(self):
        ...
        imgs = [preprocessor(self.samples[i].filePath, self.imgSize, binary=True) for i in batchRange]
